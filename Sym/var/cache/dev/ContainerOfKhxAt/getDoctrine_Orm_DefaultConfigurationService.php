...
class getDoctrine_Orm_DefaultConfigurationService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addDriver(($container->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver(['C:\\Sym\\src\\Entity'], false)), 'App\\Entity');
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\UserActivityLogRepository' => ['privates', 'App\\Repository\\UserActivityLogRepository', 'getUserActivityLogRepositoryService', true],
        ], [
            'App\\Repository\\UserActivityLogRepository' => '?',
        ])));
