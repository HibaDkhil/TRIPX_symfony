...
class Post extends \App\Entity\Post implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Post' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Post' . "\0" . 'user_id', '' . "\0" . 'App\\Entity\\Post' . "\0" . 'trip_id', '' . "\0" . 'App\\Entity\\Post' . "\0" . 'title', '' . "\0" . 'App\\Entity\\Post' . "\0" . 'body', '' . "\0" . 'App\\Entity\\Post' . "\0" . 'type', '' . "\0" . 'App\\Entity\\Post' . "\0" . 'image_url', '' . "\0" . 'App\\Entity\\Post' . "\0" . 'created_at', '' . "\0" . 'App\\Entity\\Post' . "\0" . 'updated_at', '' . "\0" . 'App\\Entity\\Post' . "\0" . 'is_confirmed', '' . "\0" . 'App\\Entity\\Post' . "\0" . 'comments'];
        }
    ...
    public function getTripId(): ?int
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTripId', []);

        return parent::getTripId();
    }
    ...
    public function setTripId(?int $trip_id): static
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTripId', [$trip_id]);

        return parent::setTripId($trip_id);
    }
    ...
    public function setIsConfirmed(?bool $is_confirmed): static
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsConfirmed', [$is_confirmed]);

        return parent::setIsConfirmed($is_confirmed);
    }
